...
<div class = "row">
    ...
    <div class="col-sm-12 col-md-6" style="margin-top: 20px; margin-bottom: 20px;">

        <div class="text-center" style="padding-left: 15px; padding-right: 15px; padding-bottom: 25px;margin-left:5px;">
       
                        <div class="shadow p-3 mb-2 bg-body rounded">
                            <div class="row">
                                <div class="col-4" >
                            <h6 style = "color:#4A0404; text-align:justify;">Location:</h6>
                                </div>
                                <div class="col-8">
                        ...
                        <div class="shadow p-3 mb-2 bg-body rounded">
                             <div class="row">
                                <div class="col-4">
                            <h6 style = "color:#4A0404; text-align:justify;">Address:</h6>
                                </div>
                                <div class="col-8">
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row" >
                        <div class="col-4">
                            <h6 style = "color:#4A0404; text-align:justify;">Telephone:</h6>
                        </div>
                        <div class="col-8">
                            <h6 style = "text-align:justify;">09165573514</h6>
                            <h6 style = "text-align:justify;">09023453660 </h6>
                        </div>
                    </div>
                </div>
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row">
                        <div class="col-4">
                            <h6 style = "color:#4A0404; text-align:justify;">Email:</h6>
                        </div>
                        <div class="col-8">
                ...
                <div class="shadow p-3 mb-2 bg-body rounded">
                    <div class="row">
                        <div class="col-4">
                            <h6 style = "color:#4A0404; text-align:justify;">Website:</h6>
                        </div>
                        <div class="col-8">
                ...
                <div class="col-sm-12 col-md-5"  style="font-family: 'Quicksand', sans-serif; padding-left: 40px; border-left: 5px solid; border-left-color:#FFE5B4; background-color:#FFFEFA;">
                     <h1 class="mt-3 pt-3" style="font-size: 22px; text-color: black; margin-left:30px; color:#4A0404;"><b>GET IN TOUCH</b></h1>
                
                    <form action="#">
						<div class="row form-group">
							<div class="col-10" style = "margin-bottom:10px; margin-left:20px;">
						...
						<div class="form-group" style = "margin-bottom:10px; margin-left:20px;">
...
<div class = "row">
    <div class = "container-fluid">
<div class="col-12" style = "margin-top: 40px; padding-right: 10px; padding-left:10px;">
          <div class="container card" style = "width:100%; height:500px;">
          <iframe id = "map-iframe" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15887.331919000448!2d6.941180016540041!3d5.44231508091392!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x10425b7eb772dc23%3A0xa6046d93de08023c!2s460117%2C%20Avu%2C%20Imo!5e0!3m2!1sen!2sng!4v1685436827990!5m2!1sen!2sng" height = "500px" style="border:10px; margin-bottom:20px; margin-top:10px;" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
